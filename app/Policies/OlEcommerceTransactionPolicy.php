...
class OlEcommerceTransactionPolicy
{
    ...
    {
        return $user->can('view_any_ol::ecommerce::transaction');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, OlEcommerceTransaction $olEcommerceTransaction): bool
    {
        return $user->can('view_ol::ecommerce::transaction');
    }
    ...
    {
        return $user->can('create_ol::ecommerce::transaction');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, OlEcommerceTransaction $olEcommerceTransaction): bool
    {
        return $user->can('update_ol::ecommerce::transaction');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, OlEcommerceTransaction $olEcommerceTransaction): bool
    {
        return $user->can('delete_ol::ecommerce::transaction');
    }
    ...
    {
        return $user->can('restore_ol::ecommerce::transaction');
    }
