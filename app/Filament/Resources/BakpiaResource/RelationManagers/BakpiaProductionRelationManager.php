...
class BakpiaProductionRelationManager extends RelationManager
{
    protected static string $relationship = 'bakpiaProduction';

    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('bakpia_production')
                    ->required()
                    ->maxLength(255),
            ]);
    }
