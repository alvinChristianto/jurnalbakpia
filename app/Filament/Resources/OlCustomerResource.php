...
{
    protected static ?string $model = OlCustomer::class;
    ...
    {
        return [
            'index' => Pages\ListOlCustomers::route('/'),
            'create' => Pages\CreateOlCustomer::route('/create'),
            'edit' => Pages\EditOlCustomer::route('/{record}/edit'),
        ];
    }
}
